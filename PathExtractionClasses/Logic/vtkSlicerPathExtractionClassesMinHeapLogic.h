...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesMinHeapLogic.h,v $
Language:  C++
...
=========================================================================*/
  // .NAME vtkSlicerPathExtractionClassesMinHeapLogic - Implementation of the min heap data structure.
  // .SECTION Description
...
#ifndef __vtkSlicerPathExtractionClassesMinHeapLogic_h
#define __vtkSlicerPathExtractionClassesMinHeapLogic_h
...
class VTK_SLICER_PATHEXTRACTIONCLASSES_MODULE_LOGIC_EXPORT vtkSlicerPathExtractionClassesMinHeapLogic : public vtkObject
{
  public: 
  vtkTypeMacro(vtkSlicerPathExtractionClassesMinHeapLogic,vtkObject);
  void PrintSelf(ostream& os, vtkIndent indent); 

  static vtkSlicerPathExtractionClassesMinHeapLogic *New();
  ...
  protected:
  vtkSlicerPathExtractionClassesMinHeapLogic();
  ~vtkSlicerPathExtractionClassesMinHeapLogic();  
  ...
  private:
  vtkSlicerPathExtractionClassesMinHeapLogic(const vtkSlicerPathExtractionClassesMinHeapLogic&);  // Not implemented.
  void operator=(const vtkSlicerPathExtractionClassesMinHeapLogic&);  // Not implemented.
};
