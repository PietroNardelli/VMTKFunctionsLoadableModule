...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic.cxx,v $
Language:  C++
...
#include "vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic.h"
#include "vtkvmtkConstants.h"
#include "vtkPolyDataNormals.h"
#include "vtkDelaunay3D.h"
#include "vtkSlicerPathExtractionClassesInternalTetrahedraExtractorLogic.h"
#include "vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic.h"
#include "vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic.h"
#include "vtkArrayCalculator.h"
#include "vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic.h"
#include "vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic.h"
#include "vtkMath.h"
...
vtkStandardNewMacro(vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic);

vtkCxxSetObjectMacro(vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic,SourceSeedIds,vtkIdList);
vtkCxxSetObjectMacro(vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic,TargetSeedIds,vtkIdList);
vtkCxxSetObjectMacro(vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic,CapCenterIds,vtkIdList);

vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic()
{
...
int vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  if (this->GenerateDelaunayTessellation)
    ...
    vtkSlicerPathExtractionClassesInternalTetrahedraExtractorLogic* internalTetrahedraExtractor = vtkSlicerPathExtractionClassesInternalTetrahedraExtractorLogic::New();
  ...
  vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic* voronoiDiagramFilter = vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::New();
  ...
  if (this->SimplifyVoronoi)
    {
    vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic* voronoiDiagramSimplifier = vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic::New();
  ...
  vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic* voronoiFastMarching = vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::New();
  ...
  vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic* centerlineBacktracing = vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic::New();
...
void vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::FindVoronoiSeeds(vtkUnstructuredGrid *delaunay, vtkIdList *boundaryBaricenterIds, vtkDataArray *normals, vtkIdList *seedIds)
{
  vtkIdType i, j;
...
void vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::AppendEndPoints(vtkPoints* endPointPairs)
{
...
void vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::ResampleCenterlines()
{
  vtkPolyData* output = this->GetOutput();
...
void vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::ReverseCenterlines()
{
  vtkPolyData* output = this->GetOutput();
...
void vtkSlicerPathExtractionClassesPolyDataCenterlinesLogic::PrintSelf(ostream& os, vtkIndent indent)
{
