...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic.cxx,v $
Language:  C++
...
vtkStandardNewMacro(vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic);

vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic()
{
  this->BuildLines = 0;
...
int vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::FillInputPortInformation(int, vtkInformation *info)
{
  info->Set(vtkAlgorithm::INPUT_REQUIRED_DATA_TYPE(), "vtkUnstructuredGrid");
  return 1;
}

void vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::ExtractUniqueEdges(vtkUnstructuredGrid* input, vtkCellArray* edgeArray)  // could be a class
{
  int isVisited;
  vtkIdType i, j, k;
  vtkIdType edgePts[2];
...
void vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::BuildVoronoiPolys(vtkUnstructuredGrid* input, vtkCellArray* voronoiPolys)
{
  bool boundaryTetra;
  vtkIdType npts, *pts;
  pts = NULL;
...
int vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::RequestData(
...
void vtkSlicerPathExtractionClassesVoronoiDiagram3DLogic::PrintSelf(ostream& os, vtkIndent indent)
{
