...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic.cxx,v $
Language:  C++
...
vtkStandardNewMacro(vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic);

vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic::vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic()
{
...
vtkIdType vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic::IsBoundaryEdge(vtkCellLinks* links, vtkIdType* edge)
{
  vtkIdType j, k;
...
int vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic::RequestData(
...
void vtkSlicerPathExtractionClassesSimplifyVoronoiDiagramLogic::PrintSelf(ostream& os, vtkIndent indent)
{
