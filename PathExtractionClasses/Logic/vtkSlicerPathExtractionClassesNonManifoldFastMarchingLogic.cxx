...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic.cxx,v $
Language:  C++
...
vtkStandardNewMacro(vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic);


vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic()
{
  this->Seeds = NULL;
  this->TScalars = vtkDoubleArray::New();
  this->StatusScalars = vtkCharArray::New();
  this->ConsideredMinHeap = vtkSlicerPathExtractionClassesMinHeapLogic::New();
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::InitPropagation(vtkPolyData* input)
{
  vtkIdType i, j, k, l;
  vtkIdType pointId;
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::GetNeighbors(vtkPolyData* input, vtkIdType pointId, vtkIdList* neighborIds)
{
  vtkIdType i, j;
  vtkIdType npts, *pts, *cells;
  unsigned short ncells;
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::SolveQuadratic(double a, double b, double c, char &nSol, double &x0, double &x1)
{
  double delta, q;
...
double vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::ComputeUpdateFromCellNeighbor(vtkPolyData* input, vtkIdType neighborId, vtkIdType* trianglePts)
{
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::UpdateNeighbor(vtkPolyData* input, vtkIdType neighborId)
{
  vtkIdType i, j, k;
  vtkIdType npts, *pts;
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::UpdateNeighborhood(vtkPolyData* input, vtkIdType pointId)
{
  vtkIdList* neighborIds;
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::Propagate(vtkPolyData* input)
{
...
int vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::RequestData(
...
void vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic::PrintSelf(ostream& os, vtkIndent indent)
{
