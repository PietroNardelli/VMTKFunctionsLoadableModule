...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic.cxx,v $
Language:  C++
...
vtkStandardNewMacro(vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic);

vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic::vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic()
{
...
double vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic::GetSteepestDescentInCell(vtkPolyData* input, vtkIdType cellId, vtkIdType* edge, double s, vtkIdType* steepestDescentEdge, double &steepestDescentS, double &steepestDescentLength)
{
...
double vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic::GetSteepestDescent(vtkPolyData* input, vtkIdType* edge, double s, vtkIdType* steepestDescentEdge, double &steepestDescentS)
{
  double descent, steepestDescent;
...
int vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic::RequestData(
...
void vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic::PrintSelf(ostream& os, vtkIndent indent)
{
