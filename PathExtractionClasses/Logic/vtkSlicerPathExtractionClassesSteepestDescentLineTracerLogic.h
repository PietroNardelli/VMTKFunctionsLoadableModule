...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic.h,v $
Language:  C++
...
=========================================================================*/
  // .NAME vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic - Trace the steepest descent line over a polygonal non-manifold.
  // .SECTION Description
...
#ifndef __vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic_h
#define __vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic_h

#include "vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic.h"
...
class VTK_SLICER_PATHEXTRACTIONCLASSES_MODULE_LOGIC_EXPORT vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic : public vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic
{
public:
  vtkTypeMacro(vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic,vtkSlicerPathExtractionClassesNonManifoldSteepestDescentLogic);
  void PrintSelf(ostream& os, vtkIndent indent); 

  static vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic *New();
...
protected:
  vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic();
  ~vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic();
  ...
  private:
  vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic(const vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic&);  // Not implemented.
  void operator=(const vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic&);  // Not implemented.
};
