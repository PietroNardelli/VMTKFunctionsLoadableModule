...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic.cxx,v $
Language:  C++
...
vtkStandardNewMacro(vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic);

vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic::vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic()
{
  this->Seeds = NULL;
  this->Targets = NULL;
...
void vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic::Backtrace(vtkPolyData* input, vtkIdType seedId)
{
  bool done;
...
int vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic::RequestData(
...
void vtkSlicerPathExtractionClassesSteepestDescentLineTracerLogic::PrintSelf(ostream& os, vtkIndent indent)
{
