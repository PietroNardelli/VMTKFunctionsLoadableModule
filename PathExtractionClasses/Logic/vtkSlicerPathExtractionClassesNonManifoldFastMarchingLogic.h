...
Program:   VMTK
Module:    $RCSfile: vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic.h,v $
Language:  C++
...
=========================================================================*/
  // .NAME vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic - Implementation of the Fast Marching Method on polygonal non-manifolds.
  // .SECTION Description
...
#ifndef __vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic_h
#define __vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic_h
...
class VTK_SLICER_PATHEXTRACTIONCLASSES_MODULE_LOGIC_EXPORT vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic : public vtkPolyDataAlgorithm
{
  public:
  vtkTypeMacro(vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic,vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent); 

  static vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic *New();
  ...
  protected:
  vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic();
  ~vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic();
  ...
  vtkSlicerPathExtractionClassesMinHeapLogic* ConsideredMinHeap;
  ...
  private:
  vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic(const vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic&);  // Not implemented.
  void operator=(const vtkSlicerPathExtractionClassesNonManifoldFastMarchingLogic&);  // Not implemented.
};
